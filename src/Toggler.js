...
const Content = ({ toggle, color, scale, shape, start, end, stop, rotation, text, opacity }) => (
  ...
  <div style={{ ...styles.container, background: `transparent` }}>
    <svg
      style={{ ...styles.shape, transform: `scale3d(${scale}, ${scale}, ${scale}) rotate(${rotation})`, borderStyle: 'solid', borderWidth: '2px' }}
      version="1.1"
      viewBox="0 0 400 400">
...
class Toggler extends React.Component {
  ...
  render() {
    ...
    const experience = 'stuff/more stuff'
    const text = toggle ? '' : experience
    return (
